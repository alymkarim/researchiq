...
def build_document_from_pdf(
    ...
    try:
        ...
        return Document(
            ...
            pdf_content=file_bytes if file_bytes else None,
        )
...
def get_document_pdf(
    ...
    raise HTTPException(
        status_code=status.HTTP_404_NOT_FOUND,
        detail="PDF file not found. Please re-upload the document.",
    )
...
async def upload_documents(
    ...
    try:
        for file in files:
            ...
            saved_path, original_filename, file_bytes = await save_uploaded_pdf(file)
